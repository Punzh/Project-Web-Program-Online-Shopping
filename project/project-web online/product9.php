...
<body>
    <div class="container">
        <h2>[🛒] เซย่าไก่ตัน 249 บาท</h2>
        <img class="product-image" src="9.png" alt="Product 9">
        <p>Price: 249 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">249</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 249; // Assuming fixed price for the product
