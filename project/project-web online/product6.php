...
<body>
    <div class="container">
        <h2>[🛒] เซย่าไก่ตัน 179 บาทาท</h2>
        <img class="product-image" src="6.png" alt="Product 6">
        <p>Price: 179 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">179</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 179; // Assuming fixed price for the product
