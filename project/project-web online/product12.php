...
<body>
    <div class="container">
        <h2>[🛒] โคตรคุ้ม ผลเซย่าชีต้าถาวร</h2>
        <img class="product-image" src="12.gif" alt="Product 12">
        <p>Price: 800 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">800</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 800; // Assuming fixed price for the product
