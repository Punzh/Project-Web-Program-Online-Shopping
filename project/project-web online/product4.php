...
<body>
    <div class="container">
        <h2>[🛒] เซย่าไก่ตัน 49 บาท</h2>
        <img class="product-image" src="4.gif" alt="Product 4">
        <p>Price: 49 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">49</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 49; // Assuming fixed price for the product
