...
<body>
    <div class="container">
        <h2>[🛒] เซย่าไก่ตัน 5 บาท</h2>
        <img class="product-image" src="2.gif" alt="Product 2">
        <p>Price: 5 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">5</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 5; // Assuming fixed price for the product
