...
<body>
    <div class="container">
        <h2>[🛒] โคตรคุ้ม ผลเซย่าเหินเวหาถาวร</h2>
        <img class="product-image" src="11.gif" alt="Product 11">
        <p>Price: 1500 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">1500</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 1500; // Assuming fixed price for the product
