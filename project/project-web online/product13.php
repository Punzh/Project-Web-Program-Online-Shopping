...
<body>
    <div class="container">
        <h2>[🛒] โคตรคุ้ม ผลเซย่าก้านกล้วยถาวร</h2>
        <img class="product-image" src="13.gif" alt="Product 13">
        <p>Price: 1000 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">1000</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 1000; // Assuming fixed price for the product
