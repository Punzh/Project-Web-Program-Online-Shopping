...
<body>
    <div class="container">
        <h2>[🛒] เซย่าไก่ตัน 250 บาท</h2>
        <img class="product-image" src="5.gif" alt="Product 5">
        <p>Price: 250 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">250</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 250; // Assuming fixed price for the product
