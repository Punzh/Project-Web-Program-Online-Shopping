...
<body>
    <div class="container">
        <h2>[🛒] เซย่าไก่ตัน 1 บาท</h2>
        <img class="product-image" src="1.gif" alt="Product 1">
        <p>Price: 1 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">1</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 1; // Assuming fixed price for the product
