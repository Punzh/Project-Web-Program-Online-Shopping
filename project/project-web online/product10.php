...
<body>
    <div class="container">
        <h2>[🛒] เซย่าไก่ตัน 399 บาท</h2>
        <img class="product-image" src="10.png" alt="Product 10">
        <p>Price: 399 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">399</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 399; // Assuming fixed price for the product
