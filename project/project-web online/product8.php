...
<body>
    <div class="container">
        <h2>[🛒] เซย่าไก่ตัน 199 บาท</h2>
        <img class="product-image" src="8.png" alt="Product 8">
        <p>Price: 199 บาท</p>
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" class="quantity-input" value="1" min="1">
        <p>Total Price: <span id="total-price">199</span> บาท</p>
    ...
    <script>
        ...
        quantityInput.addEventListener('change', function() {
            ...
            const price = 300; // Assuming fixed price for the product
